...
public class CheckEditForm extends HttpServlet {
	/*
	...
	*/
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if( submitValue!=null && submitValue.equals("Back")==true ){
		...
		String prevUserName = (String)session.getAttribute("userName");
		...
		try{
			...
			else if( userName.equalsIgnoreCase(prevUserName)==false && regUserInfoTable.isUserExist(userName)==true ){
				isRegistrationValid = false;
			...
			else if( isRegistrationValid==true && mailSenderVBB.sendUpdate(emailId, userName, newPassword)==false ){
				isRegistrationValid = false;
		...
		if( isRegistrationValid==false ){
			...
			regUserInfoTable.updateUser(prevUserName, firstName, lastName, userName, birthDateString, birthMonthString, birthYearString, bloodGroup, newPassword, city, mobileNumber, emailId);
